...
//@Disabled
public class TeleopStrafer_Quad_2024_Roadrunner extends OpMode {

    /* Declare OpMode members. */
    MaristBaseRobot2024_Quad_RoadRunner robot   = new MaristBaseRobot2024_Quad_RoadRunner(); // use the class created to define a Robot's hardware
    ...
    public void loop() {
        ...
        */
        ...
        robot.driveRobot(leftX,leftY,rightX);
